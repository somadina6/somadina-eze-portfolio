...
const MainPageProjectCard = forwardRef<
  HTMLDivElement,
  GetProjectsDataQueryResult[0]
>(
  (
    { title, category, description, coverImage, link, slug, skills, stack },
    ref
  ) => {
    return (
      <div
        ref={ref}
        className="dark:bg-black-100 bg-neutral-50 rounded-xl p-2 md:p-3 h-full flex flex-col relative cursor-pointer hover:scale-[1.01] transition mx-auto w-full"
      >
        <a
...
MainPageProjectCard.displayName = "MainPageProjectCard";
